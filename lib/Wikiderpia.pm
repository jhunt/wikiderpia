...
sub _derpify {
	...
	$content =~ s|To protect our independence, we'll never run ads|To protect our independence, we'll never set up a fascist religious dictatorship that suppresses the freedoms of Jimmy Wales|;
